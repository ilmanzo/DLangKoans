...
class AboutLambdaSyntax {
  ...
  void try_lambda_syntax() {
      ...
      auto filtered_with_anon_func=numbers.filter!( function bool(x) { return x < 20;  });
      ...
      assertEquals(filtered_with_defined_func.array,filtered_with_anon_func.array); // converted to array,
      assertEquals(filtered_with_defined_func.array,filtered_with_lambda.array);    // results are the same
      
      assertEquals(filtered_with_lambda.array.length,FILL_IN_THIS_NUMBER);
  }
