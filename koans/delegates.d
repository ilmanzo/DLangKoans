...
class Button
{
    ...
    void click()
    { // executes user defined callbacks
    ...
    @property string state()
    {
        ...
        return format("you clicked %d times the button %s with color %s",
                click_counter, name, color);
    }
...
unittest  // delegates_for_callback()
{
    auto b1 = new Button();
    auto b2 = new Button();
    ...
    b2.click();
    b2.click();
    assert(b1.state == FILL_IN_THIS_STRING);
    assert(b2.state == FILL_IN_THIS_STRING);
}
